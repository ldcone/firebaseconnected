...
//  private static final int MAX_PREVIEW_WIDTH = 257;
  private static final int MAX_PREVIEW_WIDTH = 640;
//  private static final int MAX_PREVIEW_WIDTH = 1920;

  /** Max preview height that is guaranteed by Camera2 API */
//  private static final int MAX_PREVIEW_HEIGHT = 257;
...
//  private static final int MAX_PREVIEW_HEIGHT = 1080;
  ...
  private final CameraDevice.StateCallback stateCallback =
          new CameraDevice.StateCallback() {
            ...
            public void onOpened(@NonNull CameraDevice currentCameraDevice) {
              ...
              Log.d("CameraDevice.statecallback","onopened");
            ...
            public void onDisconnected(@NonNull CameraDevice currentCameraDevice) {
              ...
              Log.d("CameraDevice.statecallback","onDisconnedcted");
              cameraDevice = null;
            }
  ...
  private void updateActiveModel() {
    ...
    backgroundHandler.post(() -> {
      ...
      try {
        ...
        if (model.equals(mobilenetV1Float)) {
  ...
  public void onViewCreated(final View view, Bundle savedInstanceState) {
    ...
    trackingOverlay = (OverlayView) view.findViewById(R.id.tracking_overlay1);
  ...
  public void onResume() {
    super.onResume();
    startBackgroundThread();
    Log.d("onResume","point");

    if (textureView.isAvailable()) {
      Log.d("onResume_textureView_true","point");
      openCamera(textureView.getWidth(), textureView.getHeight());
    } else {
      Log.d("onResume_textureView_false","point");
  ...
  private void setUpCameraOutputs(int width, int height) {
    ...
    try {
      for (String cameraId : manager.getCameraIdList()) {
        ...
        //first_ use this. as takingi have to solve resgistration,take photo ->
...
//      Log.d("openCamera_not_permissioned","point");
//      return;
//    } else {
//      Log.d("openCamera_permissioned","point");
//      checkedPermissions = true;
//    }
    checkedPermissions =true;
    Log.d("openCamera_setUpCameraOutputs","point");
    setUpCameraOutputs(width, height);
    Log.d("openCamera_confiqureTransform","point");
    configureTransform(width, height);
    Activity activity = getActivity();
    CameraManager manager = (CameraManager) activity.getSystemService(Context.CAMERA_SERVICE);
    try {
      ...
      Log.d("openCamera_manager","point");
    } catch (CameraAccessException e) {
...
//    backgroundThread = new HandlerThread(HANDLE_THREAD_NAME);
    backgroundThread = new HandlerThread(getClass().getName());
    backgroundThread.start();
    backgroundHandler = new Handler(backgroundThread.getLooper());
    Log.d("well starting","point");
